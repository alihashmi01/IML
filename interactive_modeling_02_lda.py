...
# Modified some parts, Ali Hashmi MIT
import numpy

MAX_KEY_WORDS = 50

INPUT_FILE_01 = 'lda_input_file_01.txt'
INPUT_FILE_02 = 'lda_input_file_02.txt'

OUTPUT_TXT_01 = 'topicsfile01.txt'
OUTPUT_TXT_02 ='topicsfile02.txt'

OUTPUT_JSON_01 ='topicsfile01.JSON'
OUTPUT_JSON_02 ='topicsfile02.JSON'

INPUT_FILE = INPUT_FILE_01
OUTPUT_TXT = OUTPUT_TXT_01
OUTPUT_JSON = OUTPUT_JSON_01
...
def main():
    ...
    parser.add_option("-f", dest="filename", help="corpus filename", default=INPUT_FILE)
